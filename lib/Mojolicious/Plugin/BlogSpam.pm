...
Returns a blogspam object, based on the given attributes.
...
All option parameters accepts strings or array references.
...
of the blogspam object, that are mandatory
(e.g. "name" or "subject").
...
The minimum number of words oft the comment text.
Defaults to 4.
